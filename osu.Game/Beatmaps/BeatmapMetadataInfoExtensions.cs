...
namespace osu.Game.Beatmaps
{
    public static class BeatmapMetadataInfoExtensions
    {
        ...
        /// </summary>
        public static RomanisableString GetDisplayTitleRomanisable(this IBeatmapMetadataInfo metadataInfo, bool titleOnly = false)
        {
            string author = string.IsNullOrEmpty(metadataInfo.Author) || titleOnly ? string.Empty : $"({metadataInfo.Author})";
