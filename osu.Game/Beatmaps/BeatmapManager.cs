...
namespace osu.Game.Beatmaps
{
    ...
    public class BeatmapManager : IModelDownloader<BeatmapSetInfo>, IModelManager<BeatmapSetInfo>, IModelFileManager<BeatmapSetInfo, BeatmapSetFileInfo>, IWorkingBeatmapCache, IDisposable
    {
        ...
        public bool Download(IBeatmapSetInfo model, bool useSayobot, bool minimiseDownloadSize = false)
        {
        ...
        public bool Download(BeatmapSetInfo model, bool useSayobot, bool minimiseDownloadSize = false)
        {
            return beatmapModelDownloader.Download(model, useSayobot, minimiseDownloadSize);
        }
