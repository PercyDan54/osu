...
namespace osu.Game.Screens.Menu
{
    public class ButtonSystem : Container, IStateful<ButtonSystemState>, IKeyBindingHandler<GlobalAction>
    {
        ...
        private void load(AudioManager audio, IdleTracker idleTracker, GameHost host)
        {
            ...
            buttonsPlay.Add(new MainMenuButton(@"Mvis player", @"button-generic-select", FontAwesome.Solid.Play, new Color4(0, 86, 73, 255), () => OnMvis?.Invoke()));
            buttonsPlay.Add(new MainMenuButton(@"Replay compare", @"button-generic-select", FontAwesome.Solid.SyncAlt, new Color4(0, 86, 73, 255), () => OnReplayVs?.Invoke()));
